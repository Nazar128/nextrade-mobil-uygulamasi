...
import { Plus, Search, X, UploadCloud, Loader2 } from 'lucide-react-native';
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={{padding: 20}}>
              ...
              <View style={{flexDirection: 'row', gap: 10}}>
                <TextInput style={[styles.modalInput, {flex: 1}]} placeholder="İndirim %" placeholderTextColor="#475569" value={formData.discount} onChangeText={t => setFormData({...formData, discount: t})} />
...
const styles = StyleSheet.create({
  ...
  tabContainer: { flexDirection: 'row', gap: 10, marginTop: 5 },
  ...
  addButtonText: { fontWeight: '900', fontSize: 10 },
